...
require (
	...
	go.opentelemetry.io/collector/extension/zpagesextension v0.142.0 // indirect
	...
	go.opentelemetry.io/collector/internal/testutil v0.142.0 // indirect
	go.opentelemetry.io/collector/otelcol/otelcoltest v0.142.0 // indirect
