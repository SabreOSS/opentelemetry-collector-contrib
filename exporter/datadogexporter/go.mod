...
require (
	...
	github.com/DataDog/datadog-agent/pkg/trace v0.44.0-rc.1
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.44.0-rc.1 // indirect
	github.com/DataDog/datadog-go/v5 v5.1.1 // indirect
	github.com/DataDog/go-tuf v0.3.0--fix-localmeta-fork // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/attributes v0.1.1 // indirect
